...
export default function SearchPage() {
  ...
  return <main className="page narrowPage">
    ...
    {!loading && !error && results.length === 0 ? <section className="panel emptyPanel"><img className="mascotEmpty" src="/fortune-cat-cutout.webp" alt="Fortune lucky cat" /><strong>No recent launch matched.</strong><p>Try a ticker or contract address. Older launches remain verifiable through the factory and BscScan.</p></section> : null}
