...
const ZH: Record<string, string> = {
  ...
  "Custom-pair contracts are separate from the audited Standard launch and have not been audited. Fortune does not review pair tokens; the check below measures them but is not an audit.": "自定义配对合约独立于已审计的 Standard 发行，本身尚未审计。Fortune 不审核配对代币；下方检查会测量它们，但不是审计。",
  ...
  "Want a reviewed, audited pair instead?": "想要经过审核、已审计的配对？",
  ...
  "Custom-pair contracts are an unaudited beta, separate from Fortune's audited Standard launch.": "自定义配对合约是未审计的测试版，独立于 Fortune 已审计的 Standard 发行。",
  ...
  "Unaudited beta, separate from the audited Standard launch. The site never enables it on BNB Smart Chain mainnet until it passes its own audit.": "未审计测试版，独立于已审计的 Standard 发行。在通过独立审计之前，本站绝不会在 BNB Smart Chain 主网启用它。",
