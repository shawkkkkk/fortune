...
const ZH: Record<string, string> = {
  ...
  "No balance could be found to simulate with. Connect a wallet that holds this token and check again.": "找不到可用于模拟的余额。请连接持有该代币的钱包后重新检查。",
  ...
  "The network did not answer the transfer simulation. Try again in a minute.": "网络没有响应转账模拟。请一分钟后重试。",
